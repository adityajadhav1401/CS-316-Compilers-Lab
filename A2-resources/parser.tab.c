...
{
       0,    45,    45,    45,    58,    62,    69,    67,    88,    91,
      96,    99,   106,   111,   121,   133,   138,   145,   148,   155,
     164,   173,   184,   194,   204,   208,   218,   228,   232,   235,
     239,   242,   248,   269,   274,   277
};
#endif
...
static const char *const yytname[] =
{
  ...
  "ARITHOP", "INTEGER", "FLOAT", "ASSIGN", "VOID", "RETURN", "NAME", "'+'",
  "'-'", "'*'", "'/'", "'('", "')'", "'{'", "'}'", "';'", "','", "$accept",
  "program", "$@1", "declaration_list", "procedure_definition", "$@2",
  ...
  "assignment_statement", "expression", "term", "identifier", "variable",
  "constant", YY_NULLPTR
};
#endif
...
{
      25,    -6,    -6,    24,   -29,    25,   -29,   -12,   -29,     5,
       5,   -29,    20,   -29,   -29,     3,    26,   -29,   -29,    22,
      27,    23,    25,   -29,    25,   -29,    -9,   -29,     0,   -29,
     -29,    34,   -29,   -29,    14,    10,    19,   -29,   -29,   -29,
       0,   -29,   -29,     0,     0,   -29,     0,     0,     8,    28,
      29,    19,    19,   -29,   -29,   -29,   -29,   -29
};
...
static const yytype_uint8 yydefact[] =
{
      ...
      14,     1,     0,    11,    12,     0,     0,     3,    16,     0,
       0,     0,     9,     6,     8,    17,     0,    32,     0,     7,
      18,     0,    34,    35,     0,     0,    24,    27,    28,    30,
       0,    29,    31,     0,     0,    33,     0,     0,     0,    28,
      30,    22,    23,    25,    26,    21,    19,    20
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -29,   -29,   -29,   -29,   -29,   -29,   -29,    21,    -5,   -29,
      43,   -29,   -29,     6,    -8,    -7,   -25,   -28
};
...
{
      13,    31,    27,    32,    33,     8,    42,    28,    14,    41,
      29,    27,    50,    34,    18,    49,    28,    32,    33,    13,
      43,    44,    43,    44,    11,    27,    15,    45,    55,    16,
      28,     1,     2,    46,    47,    51,    52,    19,    20,    53,
      54,    22,    40,    24,    21,    10,    48,     0,    56,    57
};

static const yytype_int8 yycheck[] =
{
       5,    26,    11,     3,     4,    11,    34,    16,    20,    34,
      19,    11,    40,    13,    11,    40,    16,     3,     4,    24,
      12,    13,    12,    13,     0,    11,    21,    17,    20,     9,
      16,     6,     7,    14,    15,    43,    44,    11,    16,    46,
      47,    18,     8,    22,    17,     2,    40,    -1,    20,    20
};
...
{
       0,     6,     7,    23,    25,    29,    30,    31,    11,    32,
      32,     0,    24,    30,    20,    21,     9,    26,    11,    11,
      16,    17,    18,    28,    29,    27,    33,    11,    16,    19,
      34,    38,     3,     4,    13,    35,    36,    37,    38,    39,
       8,    38,    39,    12,    13,    17,    14,    15,    35,    38,
      39,    36,    36,    37,    37,    20,    20,    20
};

  /* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] =
{
       0,    22,    24,    23,    25,    25,    27,    26,    28,    28,
