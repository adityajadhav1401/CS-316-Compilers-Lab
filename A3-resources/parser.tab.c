...
{
       0,    59,    59,    59,    72,    76,    83,    81,   102,   105,
     110,   113,   120,   125,   135,   147,   152,   159,   162,   170,
     177,   184,   192,   197,   203,   207,   217,   220,   227,   228,
     231,   232,   233,   234,   237,   238,   241,   242,   243,   244,
     247,   248,   249,   250,   251,   252,   256,   266,   276,   280,
     290,   299,   303,   306,   310,   313,   319,   340,   345,   348
};
#endif
...
static const char *const yytname[] =
{
  ...
  "NOT_EQUAL", "AND", "OR", "NOT", "WHILE", "DO", "IF", "ELSE", "NAME",
  "'+'", "'-'", "'*'", "'/'", "'('", "')'", "'{'", "'}'", "';'", "','",
  "$accept", "program", "$@1", "declaration_list", "procedure_definition",
  "$@2", "optional_variable_declaration_list", "variable_declaration_list",
  "variable_declaration", "declaration", "variable_list", "statement_list",
  "assignment_statement", "iteration_statement", "selection_statement",
  "sequence_list", "statement", "matched_statement", "unmatched_statement",
  "logical_expression", "relational_expression", "expression", "term",
  "identifier", "variable", "constant", YY_NULLPTR
};
#endif
...
{
      35,   -15,   -15,    27,   -82,    35,   -82,    10,   -82,    18,
      18,   -82,    57,   -82,   -82,    66,    68,   -82,   -82,    52,
      67,    65,    35,   -82,    35,   -82,    43,    69,    70,    71,
     -82,     8,   -82,   -82,   -82,   -82,   -82,   -82,   -82,    91,
       2,    72,     2,   -82,   -82,     0,    63,    23,   -82,   -82,
     -82,     8,     8,    73,    36,    45,    62,    74,    75,   -82,
     -82,     8,     8,   -82,     8,     8,   -10,    76,    77,   -82,
      80,     8,     8,     8,     8,     8,     8,     8,     8,    81,
      82,    56,    23,    23,   -82,   -82,   -82,   -82,   -82,    72,
     -82,   -82,    48,    48,    48,    48,    48,    48,    78,    72,
     -82,    85,    83,     2,    84,    62,   -82,    87,    89,   -82,
     -82,    86,    90,   -82,    72,    88,   -82
};
...
static const yytype_uint8 yydefact[] =
{
      ...
      56,     0,     7,    30,    31,    32,    18,    28,    29,     0,
       0,    17,     0,    58,    59,     0,     0,    48,    51,    52,
      54,     0,     0,     0,    39,     0,     0,     0,     0,    53,
      55,     0,     0,    57,     0,     0,     0,    52,    54,    38,
       0,     0,     0,     0,     0,     0,     0,     0,     0,    18,
       0,     0,    46,    47,    49,    50,    21,    19,    20,    17,
      36,    37,    40,    41,    42,    43,    44,    45,     0,    17,
      34,    28,     0,     0,     0,     0,    23,     0,    24,    33,
      35,     0,     0,    22,    17,     0,    25
};
...
{
     -82,   -82,   -82,   -82,   -82,   -82,   -82,    92,    12,   -82,
     116,    97,   -82,   -82,   -82,   -81,   -46,   -67,    19,   -41,
     -32,   -29,     7,    30,   -26,   -38
};
...
{
      39,    58,    46,    43,    44,    43,    44,    60,   102,     8,
      79,    43,    44,    68,   101,    61,    62,    13,   104,    59,
      69,    52,    66,    86,    30,    67,    30,    11,    45,    31,
      39,    31,    30,   115,    45,   100,    13,    31,   109,    90,
      91,     1,     2,    14,    92,    93,    94,    95,    96,    97,
      64,    65,    15,    71,    72,    39,    73,    74,    75,    76,
      77,    78,   107,    27,    28,    29,    16,    30,    82,    83,
      61,    62,    31,    61,    62,    32,    27,    28,    29,    39,
      30,    20,    27,    28,    29,    31,    30,    99,    61,    62,
      18,    31,    19,    63,    84,    85,    22,    21,    40,    51,
      42,    41,    98,    70,   -26,    81,    80,   103,   105,    87,
      88,    89,   112,   -27,    24,   106,   108,   111,    10,   113,
     116,   114,    26,     0,   110
};

static const yytype_int8 yycheck[] =
{
      26,    42,    31,     3,     4,     3,     4,    45,    89,    24,
      56,     3,     4,    51,    81,    25,    26,     5,    99,    45,
      52,    19,    51,    33,    24,    51,    24,     0,    26,    29,
      56,    29,    24,   114,    26,    81,    24,    29,   105,    71,
      72,     6,     7,    33,    73,    74,    75,    76,    77,    78,
      27,    28,    34,    17,    18,    81,    11,    12,    13,    14,
      15,    16,   103,    20,    21,    22,     9,    24,    61,    62,
      25,    26,    29,    25,    26,    32,    20,    21,    22,   105,
      24,    29,    20,    21,    22,    29,    24,    31,    25,    26,
      24,    29,    24,    30,    64,    65,    31,    30,    29,     8,
      29,    31,    20,    30,    32,    30,    32,    29,    23,    33,
      33,    31,    23,    32,    22,    32,    32,    30,     2,    33,
      32,    31,    25,    -1,   105
};
...
{
       0,     6,     7,    36,    38,    42,    43,    44,    24,    45,
      45,     0,    37,    43,    33,    34,     9,    39,    24,    24,
      29,    30,    31,    41,    42,    40,    46,    20,    21,    22,
      24,    29,    32,    47,    48,    49,    51,    52,    53,    59,
      29,    31,    29,     3,     4,    26,    56,    57,    58,    59,
      60,     8,    19,    54,    55,    56,    46,    50,    54,    59,
      60,    25,    26,    30,    27,    28,    56,    59,    60,    55,
      30,    17,    18,    11,    12,    13,    14,    15,    16,    51,
      32,    30,    57,    57,    58,    58,    33,    33,    33,    31,
      55,    55,    56,    56,    56,    56,    56,    56,    20,    31,
      51,    52,    50,    29,    50,    23,    32,    54,    32,    52,
      53,    30,    23,    33,    31,    50,    32
};
...
#line 147 "parser.y" /* yacc.c:1646  */
    {
										...
										(yyval.symbol_entry_list)->push_front(ste);
									}
...
#line 152 "parser.y" /* yacc.c:1646  */
    {
										Symbol_Table_Entry *ste = new Symbol_Table_Entry(*(yyvsp[0].string_value),void_data_type,yylineno);  
										(yyvsp[-2].symbol_entry_list)->push_front(ste);
